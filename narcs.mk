...
OVERWORLDS_BURNINGGEODE_SRCS := $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/burninggeode/*.png) $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/burninggeode/*.json) $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/burninggeode/*.pal)
OVERWORLDS_BURNINGGEODE_OBJS := $(patsubst $(OVERWORLDS_DEPENDENCIES_DIR)/burninggeode/%.png,$(OVERWORLDS_DIR)/2_%.btx0,$(OVERWORLDS_BURNINGGEODE_SRCS))
...
ALL_OVERWORLDS_SRCS := $(OVERWORLDS_SRCS) $(OVERWORLDS_BURNINGGEODE_SRCS)
ALL_OVERWORLDS_OBJS := $(OVERWORLDS_OBJS) $(OVERWORLDS_BURNINGGEODE_OBJS)
...
$(OVERWORLDS_DIR)/2_%.btx0:$(OVERWORLDS_DEPENDENCIES_DIR)/burninggeode/%.png $(OVERWORLDS_DEPENDENCIES_DIR)/burninggeode/%.json $(OVERWORLDS_DEPENDENCIES_DIR)/burninggeode/%*.pal
	$(BTX) $< $@
