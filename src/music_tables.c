...
u16 MainMusicComboTable[][2] =
{
    ...
    [ANIM_MUSIC_COMBO_WITCH] = {0x22, SEQ_GS_VS_GYMREADER_KANTO},
    [ANIM_MUSIC_COMBO_DA_GUITARIST] = {0x21, SEQ_GS_VS_CHAMP},
    [ANIM_MUSIC_COMBO_SOUNDWAVE_ENGINEER] = {0x20, SEQ_GS_VS_GYMREADER},
    [ANIM_MUSIC_COMBO_SLEEPYGUY] = {0x28, SEQ_GS_VS_ROCKET},
    [ANIM_MUSIC_COMBO_ORION] = {0x1D, SEQ_GS_VS_GYMREADER},
};
...
u8 TrainerClassToMusicCombo[][2] =
{
    ...
    // (***END OF VANILLA ENTRIES***)
    {TRAINERCLASS_WITCH, ANIM_MUSIC_COMBO_WITCH*4},
    {TRAINERCLASS_DA_GUITARIST, ANIM_MUSIC_COMBO_DA_GUITARIST*4},
    {TRAINERCLASS_SOUNDWAVE_ENGINEER, ANIM_MUSIC_COMBO_SOUNDWAVE_ENGINEER*4},
    {TRAINERCLASS_SLEEPYGUY, ANIM_MUSIC_COMBO_SLEEPYGUY*4},
    {TRAINERCLASS_ORION, ANIM_MUSIC_COMBO_ORION*4},
};
...
struct TrainerMusic sTrainerEncounterMusicParam[] = // cues which music sequence occurs upon eyes meeting
{
    ...
    {.class = TRAINERCLASS_WITCH, .music1 = SEQ_GS_EYE_BOUZU, .music2 = SEQ_GS_EYE_BOUZU},
    {.class = TRAINERCLASS_DA_GUITARIST, .music1 = SEQ_GS_BA_BRAIN, .music2 = SEQ_GS_BA_BRAIN},
    {.class = TRAINERCLASS_SOUNDWAVE_ENGINEER, .music1 = SEQ_GS_PT_OPEN, .music2 = SEQ_GS_PT_OPEN},
    {.class = TRAINERCLASS_SLEEPYGUY, .music1 = SEQ_GS_EYE_ROCKET, .music2 = SEQ_GS_EYE_ROCKET},
    {.class = TRAINERCLASS_ORION, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},

    {.class = TRAINERCLASS_KATE, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_GABRIELLA, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_AUSTIN, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_ABBY, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_CLAY, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_VICTOR, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_BRENNAN, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_ANDREW, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_SONJA, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_JULIAN, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_PKMN_TRAINER_JULIAN, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_LAURA, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_BRUCE, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_ZAK, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_JUSTIN, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_DANIEL, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_ISAAC, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_SAMER, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
};
