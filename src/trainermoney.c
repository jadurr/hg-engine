...
struct TrainerMoney PrizeMoney[] = // 0x34C04 in Overlay 12; 2 bytes for trainer class ID, 2 bytes for modifier; 516 bytes in total in vanilla
{
    ...
    { .class = TRAINERCLASS_KATE, .multiplier = 40 },
    { .class = TRAINERCLASS_GABRIELLA, .multiplier = 30 },
    { .class = TRAINERCLASS_AUSTIN, .multiplier = 30 },
    { .class = TRAINERCLASS_ABBY, .multiplier = 30 },
    { .class = TRAINERCLASS_CLAY, .multiplier = 50 },
    { .class = TRAINERCLASS_VICTOR, .multiplier = 30 },
    { .class = TRAINERCLASS_BRENNAN, .multiplier = 30 },
    { .class = TRAINERCLASS_ANDREW, .multiplier = 30 },
    { .class = TRAINERCLASS_SONJA, .multiplier = 70 },
    { .class = TRAINERCLASS_JULIAN, .multiplier = 40 },
    { .class = TRAINERCLASS_PKMN_TRAINER_JULIAN, .multiplier = 40 },
    { .class = TRAINERCLASS_LAURA, .multiplier = 30 },
    { .class = TRAINERCLASS_BRUCE, .multiplier = 30 },
    { .class = TRAINERCLASS_ZAK, .multiplier = 30 },
    { .class = TRAINERCLASS_JUSTIN, .multiplier = 30 },
    { .class = TRAINERCLASS_DANIEL, .multiplier = 30 },
    { .class = TRAINERCLASS_ISAAC, .multiplier = 30 },
    { .class = TRAINERCLASS_SAMER, .multiplier = 30 },
};
